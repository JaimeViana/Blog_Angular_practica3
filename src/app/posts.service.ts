...
export class PostsService {
  ...
  constructor() {
    this.arrPosts = [
      ...
      new Post(6, 'La cerveza preferida de Fernando Simón', 'La rueda de presan del día de hoy donde se han dado a conocer las novedades acerca de la incidencia y evolución de la COVID-19 nos ha brindado este maravilloso elogio de Fernando Simón hacia la que considera la mejor cerveza de barril del panorama español: "Las mejores variedades de lúpulo y levadura se concentran en Mahou Cinco Estrellas. Una cerveza dorada, de espuma cremosa y consistente, con un sabor característico, moderado y fino, de aroma afrutado. Ni una almendra en tu garganta". El resto de marcas de la competencia no ha recibido de buen grado las palabras del director del Centro de Coordinación y Alertas y Emergencias Sanitarias (CCAES) y ya están pidiendo su dimisión.', 'Ignacio Escolar', 'https://e00-marca.uecdn.es/assets/multimedia/imagenes/2020/05/23/15902161658115.jpg', '13/08/2020', 'Cervezas de barril'),
